...
const STATIC_ORIGIN = "https://back-media-3.onrender.com"; // <- ghép domain API (đảm bảo ảnh hiện)
      ...
      <div className="item-details">
        ...
        <div className="item-footer">
          {equipped ? (
            ...
            <Button onClick={() => onEquip(item._id)}>Trang bị</Button>
          )}
        </div>
      </div>
    </div>

...
const MediaVideo: React.FC<{
  ...
  className?: string;
  muted?: boolean;
}> = ({ stream, show, className, muted = true }) => {
      ...
      >
        ...
        >
          <div style={{ fontWeight: 700, fontSize: 14 }}>
            Voice —{" "}
            <span style={{ color: "#9ca3af", fontWeight: 500 }}>{roomId}</span>
          </div>
          <div style={{ display: "flex", gap: 8 }}>
            <span style={chip}>
              {joined ? "Đang tham gia" : "Chưa tham gia"}
            </span>
            {onClose && (
          ...
          return (
            ...
            >
              ...
              >
                ...
                {!isSharing && (
                  <div style={{ color: "#9ca3af", marginLeft: 12 }}>
